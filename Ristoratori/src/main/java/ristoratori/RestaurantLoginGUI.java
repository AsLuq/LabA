...
public class RestaurantLoginGUI extends JFrame {
    ...
    final protected String correctUser = "RistAdmin";
    final protected String correctPassword = "Defaultpwd";
    //</editor-fold>
    ...
    public RestaurantLoginGUI() {
        ...
        /**
         * to log checks if the entered Strings are equals to the Default values.
         */
